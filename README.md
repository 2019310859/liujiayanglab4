...
Java文件的读取和写入方法:
需要引入java.io.File;
使用FileInputStream读取文本
创建StringBuilder对象
使用FileOutputStream写入文件
使用for循环语句整理文本

## 实验结果
学生编号: 2019310849  姓名: 刘佳阳  性别: 男  作业内容:长恨歌
汉皇重色思倾国，御宇多年求不得。
杨家有女初长成，养在深闺人未识。
天生丽质难自弃，一朝选在君王侧。
回眸一笑百媚生，六宫粉黛无颜色。
...
## 实验感想
通过本次实验了解了string的用法，学会了在Java中如何读取，复制，写入文件。程序编写过程中并未发现需要异常处理的地方，所以没有加入异常处理代码，但也了解了异处理结构，通过try、catch、finally处理程序中可能出现的异常。处理异常包括程序本身的异常或是用户操作异常，在今后的编程中如果有需要使用的地方，我认为我可以正确的使用异常处理方法。
